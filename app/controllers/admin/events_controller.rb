class Admin::EventsController < AdminController
  before_action :find_params, only: [:show , :update, :edit, :destroy, :reorder]
  ...
  def show
        ...
        datasets: Registration::STATUS.map do |s|
          {
            ...
            data: @event.tickets.map{ |t| t.registrations.by_status(s).size },
    ...
    @data2 = {
      ...
      datasets: [{
          label: '# of Amount',
          data:  @event.tickets.map{ |t| t.registrations.by_status("confirmed").size * t.price },
